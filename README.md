...
SUXBoard(SUX)는 어느정도 프로그래밍 지식을 가지고 있는 개발자가 쉽고, 편리하게 확장해서 사용할 수 있는 게시판 통합관리 솔루션입니다. 누구나 사용 또는 개작할 수 있는 오픈 라이센스 입니다. <br>단 카피라이터는 삭제할 수 없습니다. 알았습니까? 와 뭔냐 싱크가 안된다.
