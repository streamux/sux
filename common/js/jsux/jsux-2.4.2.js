...
(function( manager, exports ) {
  ...
  manager.plugin = {
    ...
    getSwiper: function(className, option) {
      return this.createSwiper(className, option);
    },
  ...
  Logger = function(logLevel) {
    ...
    this.error = function(msg, file, nline) {
      this.log( LogLevel.ERROR, msg, file, nline);
    };
  ...
  manager.logger = new Logger( LogLevel.DEBUG );  
