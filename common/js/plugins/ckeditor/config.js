...
CKEDITOR.editorConfig = function( config ) {
  ...
  config.filebrowserImageBrowseUrl = jsux.rootPath + 'common/js/plugins/ckfinder/ckfinder.html';     
  config.filebrowserImageUploadUrl = jsux.rootPath + 'common/js/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images';
