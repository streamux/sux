...
?>
	...
	<div class="container">
		<div class="articles ui-edgebox">
			<div class="del">
				<h2 class="blind">접속키워드 삭제 알림</h2>
				<div class="tt">
					<div class="imgbox">
						<span>접속키워드 삭제 알림</span>	
					</div>
				</div>
				<div class="box">
					<ul>
						<li>
							...
							<span class="title1"><? echo $name ?> 접속키워드를 정말로 삭제 하시겠습니까?</span>
...
<script type="text/javascript" src="./tpl/js/analysis.delpass.js"></script>
