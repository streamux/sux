...
<script type="jquery-templete" id="totallogList_tmpl">
	<tr>
		...
		<td>
			<a href="analysis.resetpass.php?id=${id}&name=${name}&pageType=totallog">
				<img src="tpl/images/btn_reset.gif" alt="초기화버튼">
			</a></td>
		<td>
			<a href="analysis.delpass.php?id=${id}&name=${name}&pageType=totallog">
...
<script type="text/javascript" src="./tpl/js/analysis.list.js"></script>
