				...
				<div class="box">
					<ul>
						<li>
							...
							<span class="title1"><? echo ${adm_name} ?> 회원그룹을 정말로 삭제 하시겠습니까?</span>
							<input type="hidden" name="id" value=<? echo $table_name ?>>
						</li>
						<li>
...
<script type="text/javascript" src="./tpl/js/member.groubdelpass.js"></script>
