...
?>
	...
	<div class="container">
		<div class="articles ui-edgebox">
			<div class="del">
				<h2 class="blind">페이지뷰 초기화 알림</h2>
				<div class="tt">
					<div class="imgbox">
						<span>페이지뷰 초기화 알림</span>	
					</div>
				</div>
				<div class="box">
					<ul>
						<li>
							...
							<span class="title1"><? echo $name; ?> 페이지뷰를 정말로 초기화 하시겠습니까?</span>
...
<script type="text/javascript" src="./tpl/js/pageview.resetpass.js"></script>
