    <div class="sx-content sx-admin-main">
      <section class="sx-analytics-panel">
        <h1 class="title">페이지뷰 삭제</h1>
        <div class="sx-box-content">
          <form action="{$rootPath}analytics-admin/pageview-delete">
            ...
            <div class="row title_group">
              <img src="{$rootPath}modules/admin/tpl/images/icon_stop.gif" width="30" height="13" alt="경고아이콘" class="icon"> <span class="title1">{$documentData.name} 페이지뷰를 정말로 삭제 하시겠습니까?</span><span class="title2">다시한번 잘 확인해 주세요.</span>    
            </div>
