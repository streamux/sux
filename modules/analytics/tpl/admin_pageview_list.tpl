    <div class="sx-contents sx-admin-main">
      <section class="sx-pageview-panel">
        <header class="header">
          <h1 class="title">페이지뷰 관리</h1>
          <div class="sx-row clearfix">
            <span class="search_title">전체 키워드(0)</span>     
            <a href="{$rootPath}analytics-admin/pageview-add" class="sx-btn pull-right" title="키워드 추가">키워드 추가</a>
          </div>
        </header>
        <article class="sx-box-content">
          <input type="hidden" name="list_json_path" value="{$rootPath}analytics-admin/pageview-list-json">
          ...
          <div class="list_pc_panel">
            <table class="table" summary="페이지 뷰 정보를 제공합니다.">
              <caption class="sr-only">페이지 뷰 목록</caption>
              <thead>
                <tr>
                  <th class="sx_no">번호</th>
                  <th class="sx_name">키워드</th>
                  <th class="sx_hit">뷰 횟수</th>
...
<script type="jquery-templete" id="dataListTmpl">
  <tr>
    ...
    {/literal}
    <td>
      <a href="{$rootPath}analytics-admin/{literal}${id}{/literal}/pageview-reset" class="sx-btn sx-btn-info">초기화</a>
    </td>
    <td>
      <a href="{$rootPath}analytics-admin/{literal}${id}{/literal}/pageview-delete" class="sx-btn sx-btn-warning">삭제</a>
    </td>
  </tr>
</script>
<!-- pc end -->
