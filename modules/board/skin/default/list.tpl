...
<div class="board_list" style="width:{$groupData.width}">
  ...
  <div class="form_search_panel">
    <form action="{$routeURI}" method="post" name="f_board_list_search" class="sx-form-inline pull-right">
      ...
      <div class="sx-input-group">      
        ...
        <input type="text" name="search" size="25" class="sx-form-control sx-space-center" placeholder="검색어를 입력하세">
        <button type="submit" class="sx-btn"><i class="xi-search"></i>검색</button>
        <a href="{$routeURI}/write{$params}" class="sx-btn sx-space-left"><i class="xi-pen-o"></i></a>
      </div>    
    </form>
  </div>
