...
{include file="$headerPath" title="SUX관리자 페이지 추가 - StreamUX"}
<div class="articles ui-edgebox">
	<div class="add">
		...
		<div class="box">
			<form action="{$rootPath}document-admin/add" name="f_document_admin_add" method="post">
			...
			<table summary="페이지 정보를 입력해 생성해주세요.">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" id="summary" name="summary" size="25" maxlength="50" value="기타 페이지입니다.">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="text" id="contents_path" name="contents_path" size="25" maxlength="50" value="/sux/modules/document/contents/">
						</td>
					</tr>
					<tr>
