  ...
  <div class="add">
    ...
    <div class="box">
      ...
      <table summary="페이지 정보를 입력해 생성해주세요.">
        <tr>
            <td>
              <label for="emptyName">*카테고리 이름</label>
          ...
          <tr>
            <td><label for="isReadable">읽기 허용</label></td>
            <td>
              <select name="is_readable" id="isReadable">
          ...
          <tr>
            <td><label for="contentsPath">컨텐츠 템플릿</label></td>
            <td>
              <select name="contents_path" id="contentsPath" onchange="jsux.fn.modify.loadTemplateContents(this.value);">
