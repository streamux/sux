	...
	<div class="article user-guide">
		...
		<ul class="clearfix">
			<li>
				...
				<h2>회원 관리하기</h2>
				<p>회원 관리설정을 통해 체계적으로 관리해보세요. 회원 관리 메뉴는 <a href="{$rootPath}member-group">[메뉴 > 관리자 설정 클릭 > 관리자 모드 > 회원 관리]</a>에서 회원그룹을 추가 삭제할 수 있습니다.</p>
			</li>
			<li>
				...
				<h2>게시판 관리하기</h2>
				<p>다양한 게시판를 생성해서 관리해보세요. 게시판 관리 메뉴는 <a href="{$rootPath}board-group">[메뉴 > 관리자 설정 클릭 > 관리자 모드 > 게시판 관리]</a>에서 게시판을 생성 후 용도에 맞게 설정할 수 있습니다.</p>
			</li>
			<li>
				...
				<h2>팝업 관리하기</h2>
				<p>가장 먼저 알리고 싶은 정보가 있다면 팝업관리를 이용해 보세요. 팝업 관리 메뉴는 <a href="{$rootPath}popup">[메뉴 > 관리자 설정 클릭 > 관리자 모드 > 팝업 관리]</a>에서 팝업 추가하기를 한 후 사용할 수 있습니다.</p>
			</li>								
			<li>
				...
				<h2>통계 관리하기</h2>
				<p>기본적인 통계 관리 기능을 제공합니다. 통계 관리 메뉴는 <a href="{$rootPath}analytics-connectpath">[메뉴 > 관리자 설정 클릭 > 관리자 모드 > 통계 관리]</a>에서 키워드를 추가한 후 사용 할 수 있습니다.</p>
			</li>
		</ul>	
	</div>						
</div>
