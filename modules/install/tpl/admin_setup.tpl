    ...
    <form name="f_setup_admin" action="{$rootPath}setup-admin" method="post">
      ...
      <div class="terms_box sx-edgebox">
        ...
        <div class="sx-form-group">
          ...
          <input type="text" id="adminId" name="admin_id" class="sx-form-control" placeholder="id">
        </div>
        <div class="sx-form-group">
          <label for="adminPwd" class="sx-control-label">관리자 비밀번호</label>
          <input type="password" id="adminPwd" name="admin_pwd" class="sx-form-control" placeholder="password">
        </div>
        <div class="sx-form-group">
          <label for="adminNickname" class="sx-control-label">닉네임</label>
          <input type="text" id="adminNickname" name="admin_nickname" class="sx-form-control" placeholder="nickname">
        </div>
        <div class="sx-form-group">
          <label for="adminEmail" class="sx-control-label">이메일</label>
          <input type="text" id="adminEmail" name="admin_email" class="sx-form-control" placeholder="e-mail">
        </div>
        <div class="sx-form-group">
          <label for="yourhomeUrl" class="sx-control-label">홈페이지 주소</label>
          <input type="text" id="yourhomeUrl" name="yourhome" class="sx-form-control" placeholder="your site url">
        </div>
      </div>
