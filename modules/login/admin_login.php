...
<table width="500"  border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td align="center">
			...
			<form action=myadmin_pass.php name=musimsm method=post onSubmit="return musimsm_check(this);">
				<tr>
													...
													<tr>
														...
														<td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
																...
																<tr>
																	...
																	<td></td>
																	<td><input type=password name=admin_pass size="12" maxlength="14"></td>
																</tr>
																<tr>
																	<td height="8"></td>
																	<td></td>
