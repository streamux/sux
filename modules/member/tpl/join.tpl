<section class="section sx_member">
  ...
  <form name="f_member_join" action="{$rootPath}member-join" method="post" class="sx-form-horizontal">
    ...
    <div class="sx-form-group">
      <label for="userId" class="sx-control-label sx_label_width">아이디 *</label><input type="text" id="userId" name="user_id" class="sx-form-control">
      <input type="button" name="checkID" value='아이디 중복체크' class="sx-btn sx-btn-block">
    </div>    
    <div class="sx-form-group">
      <label for="emailAddress" class="sx-control-label sx_label_width">이메일 *</label><input type="text" id="emailAddress" name="email_address" class="sx-form-control">
    </div>
    <div class="sx-form-group">
      <label for="nickName" class="sx-control-label sx_label_width">닉네임 *</label><input type="text" id="nickName" name="nickname" class="sx-form-control">
    </div>
    <div class="sx-form-group">
      <label for="userName" class="sx-control-label sx_label_width">이름 *</label><input type="text" id="userName" name="user_name" class="sx-form-control">
    </div>
    <div class="sx-form-group">
      <label for="password" class="sx-control-label sx_label_width">비밀번호 *</label><input type="password" id="password" name="password" class="sx-form-control">
    </div>
    <div class="sx-form-group">
      <label for="passwordConf" class="sx-control-label sx_label_width">비밀번호 확인 *</label><input type="password" id="passwordConf" name="password_conf" class="sx-form-control">
    </div>
    <p class="sx_text_notice">
      <img src="{$rootPath}modules/admin/tpl/images/icon_notice.gif" class="icon_notice">
