...
jsux.fn.join = {
	...
	sendJson: function( f ) {
		...
		jsux.getJSON( jsux.rootPath + 'member', params, function( e ) {
	...
	checkCorpName: function() {
		...
		jsux.getJSON( jsux.rootPath + 'member/search-corp', params, function( e ) {
			trace( e.msg );
		});
	},
	setEvent: function() {
...
jsux.fn.modify = {
	...
	checkID: function() {
		...
		jsux.getJSON( jsux.rootPath + 'member/search-id', params, function( e ) {
	...
	sendJson: function( f ) {
		...
		jsux.getJSON( jsux.rootPath + 'member', params, function( e ) {
			...
			if (e.result == 'Y') {
				// '../login/6' is logpass
				jsux.goURL(jsux.rootPath + 'login/record-logpass');
			}
		});
	},
	setEvent: function() {
