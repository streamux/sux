                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <form action="{$rootPath}menu-admin/menu" name="f_admin_menu_modify" method="post" class="sx-form-horizontal">
                        ...
                        <input type="hidden" name="menu_id" value="{literal}${menu_id}{/literal}">

                        <div class="sx-form-group">
                          <label for="emptyLabel" class="sx-control-label label_width">메뉴 아이디</label>
                          <span class="sx-form-control" disabled>{literal}${menu_id}{/literal}</span>
                        </div>
                        <div class="sx-form-group">
                          <label for="menuName" class="sx-control-label label_width">메뉴 이름</label>
                          <input type="text" id="menuName" name="menu_name" size="20" maxlength="20" value="{literal}${name}{/literal}" class="sx-form-control">
                        </div>
                        <div class="sx-form-group">
