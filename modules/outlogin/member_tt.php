<? include "../other/leave_top.php"; ?>

<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td height="60" align="center"><img src="img/m_tt_leave.gif" width="292" height="60"></td>
	</tr>
	<tr>
		<td height="20"></td>
	</tr>
	<tr>
		<td align="center">
			...
			<form action=member_tt_an.php?fmenu=<? echo $fmenu; ?>&fsubmenu=<? echo $fsubmenu; ?> method=post  name=moosimsm>
				<input type=hidden name=j value="u">
				<tr>
