...
class ComposerStaticInita69ac091d284b88b12733df800b5389a
{
    ...
    public static $classMap = array (
        ...
        'Epi' => __DIR__ . '/..' . '/jmathai/epiphany/src/Epi.php',
        'EpiApi' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiApi.php',
        'EpiCache' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiCache.php',
        'EpiCacheException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiCacheMemcacheClientDneException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiCacheMemcacheConnectException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiCacheTypeDoesNotExistException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiCache_Apc' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiCache_Apc.php',
        'EpiCache_Memcached' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiCache_Memcached.php',
        'EpiConfig' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiConfig.php',
        'EpiConfigException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiConfig.php',
        'EpiCurl' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiCurl.php',
        'EpiCurlManager' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiCurl.php',
        'EpiDatabase' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiDatabase.php',
        'EpiDatabaseConnectionException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiDatabaseException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiDatabaseQueryException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiDebug' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiDebug.php',
        'EpiException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiLogger' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiLogger.php',
        'EpiRoute' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiRoute.php',
        'EpiSession' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiSession.php',
        'EpiSessionException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiException.php',
        'EpiSessionInterface' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiSession.php',
        'EpiSessionMemcacheClientDneException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiSession_Memcached.php',
        'EpiSessionMemcacheConnectException' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiSession_Memcached.php',
        'EpiSession_Apc' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiSession_Apc.php',
        'EpiSession_Memcached' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiSession_Memcached.php',
        'EpiSession_Php' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiSession_Php.php',
        'EpiTemplate' => __DIR__ . '/..' . '/jmathai/epiphany/src/EpiTemplate.php',
